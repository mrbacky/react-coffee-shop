Feature: Sign in
    ...
    Scenario: Valid Sign in
        When I fill in "mr.backy@gmail.com" in email field and "1234567" in password field
    ...
    Scenario: Failing sign in - wrong password
        When I fill in "mr.backy@gmail.com" in email field and "11111111" in password field
        And I click Sign In button
